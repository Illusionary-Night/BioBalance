...
public static class HurtSystem
{
    ...
    public static void Hurt(CreatureData data, float damage, Creature attacker = null)
    {
    ...
    public static void Hurt(CreatureData data, float damage, Vector2 attackerPosition, Creature attacker = null)
    {
        // 計算攻擊者相對於自己的方位向量
    ...
    public static bool UnderAttack(CreatureData data)
    {
        return data.underAttackDirection != Direction.None;
    }

    /// <summary> 取得受擊方位</summary>
    public static Direction GetUnderAttackDirection(CreatureData data)
    {
        return data.underAttackDirection;
    }

    /// <summary> 取得受擊方位並立刻重置狀態，確保單次受傷僅觸發一次反應 </summary>
    public static Direction GetAndResetUnderAttackDirection(CreatureData data)
    {
    ...
    /// </summary>
    /// <param name="data">當前個體</param>
    public static void ResetUnderAttackDirection(CreatureData data)
    {
        data.underAttackDirection = Direction.None;
    }
    // TODO: 這裡要轉接給另外一個tool感覺怪怪的？
    public static void Repeled(Creature creature, Vector2 drection, float strength = 1f)
    {
